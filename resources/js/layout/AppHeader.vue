  ...
  <header class="header-global">
    <base-nav class="navbar-main" transparent type="" effect="light" expand>
      ...
      <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
        <router-link class="nav-link" slot="title" to="/">Home</router-link>
        <router-link class="nav-link" slot="title" to="/news">News</router-link>
        <router-link class="nav-link" slot="title" to="/publications">Publications</router-link>
