<template>
    <div>
        ...
        <div class="position-relative">
            ...
            <section class="section-shaped my-0">
                <div style="height: 350px;
                            ...
                            background-image: url('https://images.unsplash.com/photo-1497366754035-f200968a6e72?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1500&q=80'); background-size: cover">
                </div>
      ...
      <carousel :per-page="1" :navigate-to="someLocalProperty" :mouse-drag="false" class="col-md-8 mx-auto mt--300">
        <slide class="shadow">
          <h1 class="display-3  text-white">Our mission</h1>
        ...
        <slide class="shadow">
          <div class="card card-blog shadow border-0">
            <div class="card-image" style="background-size: cover; height: 400px; background-image: url('https://demos.creative-tim.com/now-ui-kit-pro/assets/img/project13.jpg')">
<!--              <img style="height: 10rem;" class="img rounded" src="https://demos.creative-tim.com/now-ui-kit-pro/assets/img/project13.jpg">-->
            </div>
            <div class="card-body">
